...
[bigX, bigY] = meshgrid(minX:gridX/10:maxX, minY:gridY/10:maxY);
...
h5 = plot(model.SVs(:,demension1),model.SVs(:,demension2),'r+','markersize',7,'linewidth',1.5); 
% legend([h1,h5],'正常样本','支持向量','Location','SouthEast');
% legend(h1,'正常样本','Location','NorthEast');
[C,h] = contour(bigX, bigY, bigZ,-1:0.5:-0.5,'r','linewidth',1.5); 
% clabel(C,h,'Color','r'); 
xlabel('峰峰值','FontSize',12); 
ylabel('频谱重心','FontSize',12); 
end